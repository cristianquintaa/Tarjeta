...
class TarjetaTest extends \PHPUnit_Framework_TestCase {
	...
	public function testSinTransbordo(){
		$this->tarjeta = new Baja();
		$this->assertEquals($this->tarjeta->saldo(), 0, "Si cargo 100 y pago dos colectivos sin transbordo deberia tener 84");
		$this->tarjeta->recargar(100);
		$this->assertEquals($this->tarjeta->saldo(), 100, "Si cargo 100 y pago dos colectivos sin transbordo deberia tener 84");
		$this->tarjeta->pagar($this->colectivo1, "2016/09/10 19:04");
